<nav class="navbar navbar-expand-lg navbar-dark">
  <div class="container">
    <a class="navbar-brand" href="/">
      <img src="/images/dai-current.jpg" width="30" height="30" class="d-inline-block align-top rounded" alt="">
      Dafydd Vaughan
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item<?php if(isset($site_section) && $site_section=='about') : ?> active<?php endif; ?>">
          <a class="nav-link" href="/profile" title="About Dafydd">About me</a>
        </li>
